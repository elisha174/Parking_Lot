    ...
    inquirer
      ...
      .then((answers) => {
        if (answers.vehicleType === 'Car') {
          // create a car
          this.createCar();
        } if (answers.vehicleType === 'Truck') {  // TODO: add statements to create a truck or motorbike if the user selects the respective vehicle type
          // create a truck
          this.createTruck();
    ...
    inquirer
      ...
      .then((answers) => {
        ...
        if (answers.value === 'Truck') {
          console.log(`${answers.name} cannot tow itself. Please pick another vehicle.`)
          this.chooseVehicle();
        } else {
          console.log(`${answers.name} cannot tow itself. Please pick another vehicle.`)
          this.performActions();
    ...
    inquirer
      ...
      .then((answers) => {
        ...
        if (answers.action === 'Print details') {
          ...
          console.log(`It's raining today. No wheelies.`) 
        }
